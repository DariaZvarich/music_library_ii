...
class AlbumRepository:
    ...
    def creat(self, album_id):
        self._connection.execute('INSERT INTO albums (title, release_year, artist_id) VALUES (%s, %s, %s)', [album_id.title, album_id.release_year, album_id.artist_id])
        return None
